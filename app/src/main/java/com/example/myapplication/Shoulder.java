...
public class Shoulder extends MainActivity {

    ListView listView;
    String mTitle[] = {"Barbell Overhead Press","Standing Dumbbell Fly","Face Pull","High Pull","Band Lateral Raise","Dumbbell Deadlift/Shrug Combo","Bent-Over Reverse Flye","Machine Shoulder Press"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Shoulder Exercises");
        ...
        Shoulder.MyAdapter adapter = new Shoulder.MyAdapter(this, mTitle, mDescription);
