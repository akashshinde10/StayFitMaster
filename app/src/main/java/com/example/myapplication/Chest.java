...
public class Chest extends MainActivity {

    ListView listView;
    String mTitle[] = {"Band Chest Fly","Batwing Fly","Incline Dumbbell Bench Press"," Close-Grip Bench Press","Cable Fly","Decline Dumbbell Bench Press","Plyometric Pushup","Single-Arm Dumbbell Bench Press"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Chest Exercises");
        ...
        Chest.MyAdapter adapter = new Chest.MyAdapter(this, mTitle, mDescription);
